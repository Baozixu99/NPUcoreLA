...
> ![](D:\jiawei\media\image11.jpg){width="5.76in" height="0.34833333333333333in"}
...
> ![](D:\jiawei\media\image12.jpg){width="5.533333333333333in"height="4.221666666666667in"}
...
> ![](D:\jiawei\media\image13.jpg){width="5.745in" height="2.5883333333333334in"}
...
> ![](D:\jiawei\media\image14.jpg){width="5.211666666666667in" height="5.6in"}
...
> ![](D:\jiawei\media\image15.jpg){width="4.365in" height="2.595in"}

在 /oskernel2024-npucore/user/src 目 录 下 修 改 usr\_call.rs 和syscall.rs

> ![](D:\jiawei\media\image16.jpg){width="4.736666666666666in"height="2.0433333333333334in"}
>
> ![](D:\jiawei\media\image16.jpg){width="4.736666666666666in"height="2.0433333333333334in"}

在 /oskernel2024-npucore/os/src/syscall 目 录 下 修 改 mod.rs 和process.rs

> ![](D:\jiawei\media\image18.jpg){width="4.818333333333333in" height="3.56in"}
...
> ![](D:\jiawei\media\image19.jpg){width="5.485in" height="1.8216666666666668in"}
...
> ![](D:\jiawei\media\image20.jpg){width="4.333333333333333in"height="3.6266666666666665in"}
>
> ![](D:\jiawei\media\image20.jpg){width="4.333333333333333in"height="3.6266666666666665in"}

下面编写getpid.rs来验证sys_getpid()系统调用是否正确：

> ![](D:\jiawei\media\image22.jpg){width="4.68in" height="2.0833333333333335in"}
...
> ![](D:\jiawei\media\image23.jpg){width="5.073333333333333in" height="0.94in"}
...
> ![](D:\jiawei\media\image24.jpg){width="5.566666666666666in"
> height="1.8666666666666667in"}

测试sys-getrusage系统调用是否正确：

> ![](D:\jiawei\media\image25.jpg){width="5.625in" height="3.1in"}

在 /oskernel2024-npucore/user/src 目 录 下 修 改 usr\_call.rs 和syscall.rs

> ![](D:\jiawei\media\image26.jpg){width="5.556666666666667in" height="1.82in"}
>
> ![](D:\jiawei\media\image26.jpg){width="5.556666666666667in" height="1.82in"}
...
> ![](D:\jiawei\media\image28.jpg){width="3.94in" height="0.61in"}

#### **1.2.6** 实现 **fork+exec** 系统调用

与清华⼤学开发的rCore教学操作系统不同，在NPUcore+中并没有特意实现 fork 系统调⽤，fork 就是特定参数下的 clone 系统调⽤。

> ![](D:\jiawei\media\image29.jpg){width="4.333333333333333in" height="1.23in"}

所以我们只需要在fork中调用sys\_clone，并传入相关的参数即可。sys\_clone系统调用的传参如下：

> ![](D:\jiawei\media\image30.jpg){width="4.538333333333333in" height="1.76in"}

下面开始编写sys\_fork()：

> ![](D:\jiawei\media\image31.jpg){width="5.5183333333333335in"
> height="2.1266666666666665in"}

测试fork\_test系统调用是否正确：

> ![](D:\jiawei\media\image32.jpg){width="5.156666666666666in"
> height="4.426666666666667in"}
...
> ![](D:\jiawei\media\image33.jpg){width="3.3766666666666665in"
> height="3.9183333333333334in"}
...
> ![](D:\jiawei\media\image34.jpg){width="4.28in" height="5.99in"}

#### **1.2.7** 实现 **sys\_clone** 系统调用

> ![](D:\jiawei\media\image35.jpg){width="3.565in" height="1.095in"}
...
> ![](D:\jiawei\media\image36.jpg){width="5.093333333333334in"
> height="1.1433333333333333in"}

下面我们只需要传递正确的参数，就可以通过sys\_clone实现clone系统调用：

> ![](D:\jiawei\media\image37.jpg){width="4.445in" height="4.346666666666667in"}

由于我们在前面实现fork系统调用时已经验证了sys\_clone的正确性，在此不再进行验证。

####  **1.2.8** 实现 **mmap** 系统调用扩展

> ![](D:\jiawei\media\image38.jpg){width="5.98in" height="4.968333333333334in"}
...
> ![](D:\jiawei\media\image39.jpg){width="5.66in" height="3.38in"}

编写用户态测试程序

> ![](D:\jiawei\media\image40.jpg){width="4.263333333333334in" height="5.605in"}
...
> ![](D:\jiawei\media\image41.jpg){width="4.9383333333333335in" height="0.385in"}

开启LOG结合GDB进行调试os目录下执行：make run LOG=info

> ![](D:\jiawei\media\image42.jpg){width="5.621666666666667in" height="0.42in"}
...
> ![](media/image43.jpg){width="4.128333333333333in" height="1.725in"}
